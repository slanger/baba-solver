...
namespace BabaSolver
{
	...
	uint8_t GameStateMtnE1::TurnCount() const
	{
		return _turn;
	}
	...
	std::shared_ptr<GameState> GameStateMtnE1::ApplyMove(Direction direction) const
	{
		std::shared_ptr<GameStateMtnE1> new_state = std::make_shared<GameStateMtnE1>(*this);
	...
	bool GameStateMtnE1::CheckCellAndMoveObjects(int8_t i, int8_t j, int8_t delta_i, int8_t delta_j, uint16_t prev_cell)
	{
	...
	bool GameStateMtnE1::WillGoOutOfBounds(int8_t i, int8_t j, int8_t delta_i, int8_t delta_j) const
	{
