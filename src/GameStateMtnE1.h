// Code for implementing game states for Level Extra-1 of Mountaintop ("The Floatiest Platforms").
...
namespace BabaSolver
{
	...
	public:
		...
		// GameStateMtnE1.cpp for the more details about how this bitmask is implemented.
