// Code for implementing game states for Level 6 of Mountaintop ("Floaty Platforms").
...
namespace BabaSolver
{
	...
	public:
		...
		// GameStateMtn6.cpp for the more details about how this bitmask is implemented.
	...
	public:
		...
		GameStateMtn6(const GameStateMtn6& other);
